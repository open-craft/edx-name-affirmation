...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd edx_name_affirmation && ../manage.py makemessages -l en -v1 -d django
	cd edx_name_affirmation && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd edx_name_affirmation && ../manage.py compilemessages
...
dummy_translations: ## generate dummy translation (.po) files
	cd edx_name_affirmation && i18n_tool dummy
