...
"""
edx_name_affirmation documentation build configuration file.
...
project = 'edx_name_affirmation'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'edx-name-affimation'
...
#
# html_title = 'edx_name_affirmation v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Django app housing name affirmation logic',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_name_affirmation'),
                os.path.join(root_path, 'edx_name_affirmation/migrations')])
